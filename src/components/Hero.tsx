...
function Hero({ pageInfo }: Props) {
  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
      ...
      />
      <div className="z-20">
        <h2 className="text-xs md:text-sm uppercase text-gray-300 opacity-90 pb-2 tracking-[15px]">
          {pageInfo?.role}
        </h2>
        <h3 className="text-[10px] md:text-sm uppercase text-gray-400 pb-2 tracking-[7px]">
          <span className="mr-10 lg:mr-32">Developer</span>
          <span className="ml-10 lg:ml-32">Designer</span>
        </h3>
        <h1 className="text-3xl md:text-4xl lg:text-6xl font-semibold text-white px-10 mx-auto">
